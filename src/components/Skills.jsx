                    ...
                    {fEnd.map((skill,i)=>{
                        return(
                            <Tag.Root 
                                ...
                                bgGradient='linear(315deg, #d4418e 0%, #0652c5 74%)'><Tag.Label color={'yellow.400'} >{skill}</Tag.Label></Tag.Root>
                        )
                    })} 
                    ...
                    {bEnd.map((skill,i)=>{
                        return(
                            <Tag.Root 
                                ...
                                fontWeight={'700'} 
                                color={'yellow.400'} 
                                bgGradient='linear(315deg, #d4418e 0%, #0652c5 74%)'><Tag.Label>{skill}</Tag.Label></Tag.Root>
                        )
                    })} 
  </Flex>
            </Card>
